    ...
    GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => const Authentication1Widget(),
        ),
        FFRoute(
          name: 'profile_Edit',
          path: '/profileEdit',
        ...
        FFRoute(
          name: 'ChatWithAI',
          path: '/chatWithAI',
          builder: (context, params) => const ChatWithAIWidget(),
        ),
        FFRoute(
          name: 'ResumeCreater',
          path: '/resumeCreater',
          builder: (context, params) => const ResumeCreaterWidget(),
        ),
        FFRoute(
          name: 'TopCourses',
          path: '/topCourses',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'TopCourses')
        ...
        FFRoute(
          name: 'ContributeNotes',
          path: '/contributeNotes',
          builder: (context, params) => const ContributeNotesWidget(),
        ),
        FFRoute(
          name: 'NotesViewer',
          path: '/notesViewer',
          builder: (context, params) => NotesViewerWidget(
            subjectName: params.getParam(
              'subjectName',
              ParamType.String,
            ),
            notesPdfPath: params.getParam(
              'notesPdfPath',
              ParamType.String,
            ),
        ...
        FFRoute(
          ...
          builder: (context, params) => PlaylistWidget(
            ...
            videoIDListPath: params.getParam<dynamic>(
              'videoIDListPath',
              ParamType.JSON,
              isList: true,
            ),
        ...
        FFRoute(
          ...
          path: '/searchCourses',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'SearchCourses')
              : const NavBarPage(
                  initialPage: 'SearchCourses',
                  page: SearchCoursesWidget(),
                ),
        ),
        FFRoute(
          name: 'SavedVideo',
          path: '/savedVideo',
          builder: (context, params) => const SavedVideoWidget(),
        ),
        FFRoute(
          name: 'RoadMap',
          path: '/roadMap',
          builder: (context, params) => const RoadMapWidget(),
        )
